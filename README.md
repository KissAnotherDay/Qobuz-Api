...
Added proxy for scrape animate covers and playlists directly from apple music, without apple blocking requests

# Setup
Clone the repo and insert your token etc in .env file
